...
.table>tbody>tr.active>td, .table>tbody>tr.active>th, .table>tbody>tr>td.active, .table>tbody>tr>th.active, .table>tfoot>tr.active>td, .table>tfoot>tr.active>th, .table>tfoot>tr>td.active, .table>tfoot>tr>th.active, .table>thead>tr.active>td, .table>thead>tr.active>th, .table>thead>tr>td.active, .table>thead>tr>th.active { background-color:#D8D8D8; }
  ...
  <tr>
    ...
    <td><input type="radio" name="q2" id="radio2" value="جيد" <?= $reslut['q2'] == 'جيد' ? "checked='checked'" : '' ?>></td>
    <td colspan="2"><input type="radio" name="q2" id="radio3" value="مقبول" <?= $reslut['q2'] == 'مقبول' ? "checked='checked'" : '' ?>></td>
  ...
  <tr>
    ...
    <td><input type="radio" name="q3" id="radio2" value="جيد" <?= $reslut['q3'] == 'جيد' ? "checked='checked'" : '' ?>></td>
    <td colspan="2"><input type="radio" name="q3" id="radio3" value="مقبول" <?= $reslut['q3'] == 'مقبول' ? "checked='checked'" : '' ?>></td>
