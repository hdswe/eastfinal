...
<!--  بمجريات الدورة خاص بالتسجيل      -->
  <li class="nav-parent"><a href=""><i class="fa fa-check-square-o"></i> <span>مجريات الدورة</span></a>
          <ul class="children">
...
<li class="dropdown">
    ...
    border: 0px;padding-right: 26px;color: #94989d; " class="dropdown-toggle" type="button" data-toggle="dropdown"><i class="fa fa-check-square-o"></i>البرامج
...
<li class="dropdown">
    <button style="background: #1d2939;
    border: 0px;padding-right: 26px;color: #94989d; " class="dropdown-toggle" type="button" data-toggle="dropdown"><i class="fa fa-check-square-o"></i>الحجوزرات
    <span class="caret"></span></button>
    <ul class="dropdown-menu" style="    min-width: 100%;">
...
<!-- <li class="nav-parent"><a href="" class="aaa"><i class="fa fa-check-square-o"></i> <span>الحجوزرات</span></a>
          <ul class="children1">
            <li><a href="reservation.php?do=show"><i class="fa fa-caret-left"></i> الطلبات المقدمة</a></li>
            <li><a href="reservation.php?do=confirmed"><i class="fa fa-caret-left"></i> الطلبات المؤكدة</a></li>
            <li><a href="reservation.php?do=canceled"><i class="fa fa-caret-left"></i> الطلبات الملغية</a></li>
...
$(document).ready(function(){
  $('.aaa').on("click", function(e){
    $(this).('.children1').css("display":"block");
...
<li class="dropdown">
    <button style="background: #1d2939;
    border: 0px;padding-right: 26px;color: #94989d; " class="dropdown-toggle" type="button" data-toggle="dropdown"><i class="fa fa-check-square-o"></i>الدورات
    <span class="caret"></span></button>
    <ul class="dropdown-menu" style="    min-width: 100%;">
...
<li class="dropdown">
    <button style="background: #1d2939;
    border: 0px;padding-right: 26px;color: #94989d; " class="dropdown-toggle" type="button" data-toggle="dropdown"><i class="fa fa-check-square-o"></i>الباركود
    <span class="caret"></span></button>
    <ul class="dropdown-menu" style="    min-width: 100%;">
       <li><a href="barcode.php?do=generate"><i class="fa fa-caret-left"></i>سحب الباركود</a></li>
            <li><a href="barcode.php?do=course"><i class="fa fa-caret-left"></i>تقرير حضور الدورات</a></li>
...
<!--  قسم خاص بالتسجيل      -->
  <li class="nav-parent"><a href=""><i class="fa fa-check-square-o"></i> <span>نموذج التسجيل</span></a>
          <ul class="children">
 ...
 <li class="nav-parent"><a href=""><i class="fa fa-check-square-o"></i> <span>محتوى الرئيسية</span></a>
          <ul class="children">
...
<!-- <li class="dropdown">
    <button style="background: #1d2939;
    border: 0px;padding-right: 26px;color: #94989d; " class="dropdown-toggle" type="button" data-toggle="dropdown"><i class="fa fa-check-square-o"></i>محتوى الرئيسية
    <span class="caret"></span></button>
    <ul class="dropdown-menu" style="    min-width: 100%;">
      <li <?= $this_url_page == 'banner.php' ? "class='active'" : "" ?>><a href="banner.php?do=show"><i class="fa fa-laptop"></i> <span>البنرات</span></a></li>
      <li <?= $this_url_page == 'site_frind.php' ? "class='active'" : "" ?>><a href="site_frind.php?do=show"><i class="fa fa-chain"></i> <span>مواقع صديقة</span></a></li>
