...
#############################################################
    ...
    if($_GET['do'] == 'details' and isset($_GET['id'])){
        ...
        $datas['status']      = '1';
        $where[id] = $_GET['id'];
        $update = $pdo->pdoInsUpd('trainer', $datas, 'update', $where);
...
<section>
  ...
  <div class="mainpanel">
    ...
    <?
        ...
        {
        case "show":
        include("template/trainer/show.php");
        break;
        case "details":
        include("template/trainer/details.php");
        break;
        }
