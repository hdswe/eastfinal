...
#############################################################
    ...
    if(isset($_POST['btnadd'])) {
        if($chkToken->Check()) { 
                ...
                $insert = $pdo->pdoInsUpd('center', $data);
...
#############################################################
    ...
    if(isset($_POST['btnedit'])) {
        if($chkToken->Check()) { 
                $data['title']		          = trim($_POST['title']);
                $where[id] = $_GET['id'];
                $update = $pdo->pdoInsUpd('center', $data, 'update', $where);
                header('Location: ?do=show&process=successfully');
            } else { 
               die(header("Location: login.php")); 
        }  
...
<section>
  ...
  <div class="mainpanel">
    ...
    <?
        ...
        {
        case "show":
        include("template/center/show.php");
        break;
        case "add":
        include("template/center/add.php");
        break;
        case "edit":
        include("template/center/edit.php");
        break;
        }
