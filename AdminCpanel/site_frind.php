...
#############################################################
    ...
    if(isset($_POST['btnadd'])) {
        if($chkToken->Check()) { 
                ...
                $insert = $pdo->pdoInsUpd('site_frind', $data);
...
#############################################################
    ...
    if($_GET['do'] == 'edit' and isset($_GET['id'])){
        $sql = "SELECT * FROM `site_frind` where id=:id";
        $data[id] = $_GET['id'];
    ...
    if(isset($_POST['btnedit'])) {
        if($chkToken->Check()) { 
                ...
                $data['url']		            = trim($_POST['url']);
                $where[id] = $_GET['id'];
                $update = $pdo->pdoInsUpd('site_frind', $data, 'update', $where);
                header('Location: ?do=show&process=successfully');
            } else { 
               die(header("Location: login.php")); 
        }  
...
#############################################################
    ...
    if(isset($_GET['del'])){
        $sql = "DELETE FROM `site_frind` WHERE `id`=:id";
        $data[id] = $_GET['del'];
...
<section>
  ...
  <div class="mainpanel">
    ...
    <?
        ...
        {
        case "show":
        include("template/site_frind/show.php");
        break;
        case "add":
        include("template/site_frind/add.php");
        break;
        case "edit":
        include("template/site_frind/edit.php");
        break;
        }
