            ...
            <thead>
              <tr>
               ...
               <!-- <th>عدد المدربين</th>
                ...
                <th>متوسط  الحضور في البرنامج</th>-->
                </tr>
            </thead>
            <tbody>
                <?
               ...
               <tr class="unread">
                        <td><?= $result['title'] ?></td>
                <td><a href="?do=statuscourse&programs_id=<?= $result['id'] ?>&status=1">استعراض  (
                        <?
               ...
               echo $num_rev;
                ?> )</a></td>
                <td><a href="?do=statuscourse&programs_id=<?= $result['id'] ?>&status=2">استعراض  (
                        <?
               ...
               echo $num_rev;
                ...
                <td><a href="?do=statuscourse&programs_id=<?= $result['id'] ?>&status=3">استعراض  (
                        <?
               ...
               <!--  <td><?
                 ...
                 <td><a href="?do=programdetails&programs_id=<?= $result['id'] ?>" >تفاصيل </a></td>
