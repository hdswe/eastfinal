<div class="panel panel-default">
        <div class="panel-heading">
          ...
          <h3 class="panel-title">مواقع صديقة</h3>
        </div>
        ...
        <form action="" method="post" id="showform" name="showform">
          ...
          <div class="mb30">
          <div class="col-sm-7">
          <a class="btn btn-primary" href="?do=add"><span class="fa fa-pencil-square-o"></span>&nbsp; اضافة موقع</a>
          <button name="delChecked" type="submit" id="delChecked" class="btn btn-primary"><span class="fa fa-trash-o">&nbsp; حذف المحدد</button>
          </div>
        <div class="col-sm-5">
            <div class="form-group">
                <div class="col-sm-10">
                <input name="title" type="text" class="form-control input-sm" id="title" placeholder="عنوان الموقع">
                </div>
            <div class="col-sm-2">
        ...
        <? } ?>
          ...
          <table class="table table-hidaction table-striped mb30">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM `site_frind` ".$where." ORDER BY `id` DESC LIMIT $startpoint , $limit";
