<div class="panel panel-default">
        <div class="panel-heading">
          ...
          <h3 class="panel-title">الأحياء السكنية</h3>
        </div>
        ...
        <form action="" method="post" id="showform" name="showform" >
          ...
          <div class="mb30">
          <div class="col-sm-7">
            <a class="btn btn-primary" href="?do=add"><span class="fa fa-pencil-square-o"></span>&nbsp; اضافة حي</a>
        ...
        <div class="col-sm-5">
            <div class="form-group">
                <div class="col-sm-10">
                <input name="title" type="text" class="form-control input-sm" id="title" placeholder="عنوان الحي">
                </div>
            <div class="col-sm-2">
        ...
        <? } ?>
          ...
          <table class="table table-hidaction table-striped mb30">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM `neighborhood` ".$where." ORDER BY `id` DESC LIMIT $startpoint , $limit";
