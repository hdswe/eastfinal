        ...
        <? } ?>
          ...
          <table class="table table-hidaction table-striped mb30">
            <thead>
              <tr>
                <th></th>
                <th width="50%">عنوان الاستبيان</th>
                <th>المعايير</th>
                <th>الأسئلة</th>
                <th>&nbsp;</th>
              </tr>
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM `questionnaire` ".$where." ORDER BY `id` DESC LIMIT $startpoint , $limit";
                ...
                <td><?= $result['title'] ?></td>
                <td class="table-action"><a href="#">المعايير</a></td>
                <td class="table-action"><a href="#">الأسئلة</a></td>
