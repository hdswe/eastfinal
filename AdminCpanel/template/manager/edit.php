            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                ...
                <div class="ckbox ckbox-success col-sm-6">
                    <input name="pr_login_admin" type="checkbox" value="1" id="pr_login_admin" <?= $result['pr_login_admin'] == '1' ? "checked='checked'" : "" ?>>
                    <label for="pr_login_admin">الدخول على لوحة التحكم</label>
                </div>
                <div class="ckbox ckbox-success col-sm-6">
                    <input name="pr_settings" type="checkbox" id="pr_settings" value="1" <?= $result['pr_settings'] == '1' ? "checked='checked'" : "" ?>>
                    <label for="pr_settings">التحكم في الاعددات</label>
                </div>
                <div class="ckbox ckbox-success col-sm-6">
                    <input name="pr_course" type="checkbox" value="1" id="pr_course" <?= $result['pr_course'] == '1' ? "checked='checked'" : "" ?>>
                    <label for="pr_course">التحكم في الدورات</label>
                </div>
                <div class="ckbox ckbox-success col-sm-6">
                    <input name="pr_reservation" type="checkbox" value="1" id="pr_reservation" <?= $result['pr_reservation'] == '1' ? "checked='checked'" : "" ?>>
                    <label for="pr_reservation">التحكم في الحجوزات</label>
                </div>
                <div class="ckbox ckbox-success col-sm-6">
                    <input name="pr_group" type="checkbox" value="1" id="pr_group" <?= $result['pr_group'] == '1' ? "checked='checked'" : "" ?>>
                    <label for="pr_group">التحكم في المجموعات</label>
                </div>
                <div class="ckbox ckbox-success col-sm-6">
                    <input name="pr_support" type="checkbox" value="1" id="pr_support" <?= $result['pr_support'] == '1' ? "checked='checked'" : "" ?>>
                    <label for="pr_support">التحكم في الدعم الفني</label>
                </div>
             
                <div class="ckbox ckbox-success col-sm-6">
                    <input name="pr_pages" type="checkbox" value="1" id="pr_pages" <?= $result['pr_pages'] == '1' ? "checked='checked'" : "" ?>>
                    <label for="pr_pages">التحكم في الصفحات</label>
                </div>
                
                <div class="ckbox ckbox-success col-sm-6">
                    <input name="pr_barcode" type="checkbox" value="1" id="pr_barcode" <?= $result['pr_barcode'] == '1' ? "checked='checked'" : "" ?>>
                    <label for="pr_barcode">التحكم في الباركود</label>
                </div>
                <div class="ckbox ckbox-success col-sm-6">
                    <input name="pr_revenues" type="checkbox" value="1" id="pr_revenues" <?= $result['pr_revenues'] == '1' ? "checked='checked'" : "" ?>>
                    <label for="pr_revenues">التحكم في الايرادات</label>
                </div>
                <div class="ckbox ckbox-success col-sm-6">
                    <input name="pr_city" type="checkbox" value="1" id="pr_city" <?= $result['pr_city'] == '1' ? "checked='checked'" : "" ?>>
                    <label for="pr_city">التحكم في المدن</label>
                </div>
                <div class="ckbox ckbox-success col-sm-6">
                    <input name="pr_reports" type="checkbox" value="1" id="pr_reports" <?= $result['pr_reports'] == '1' ? "checked='checked'" : "" ?>>
                    <label for="pr_reports">التحكم في التقارير</label>
                </div>
                <div class="ckbox ckbox-success col-sm-6">
                    <input name="pr_users" type="checkbox" value="1" id="pr_users" <?= $result['pr_users'] == '1' ? "checked='checked'" : "" ?>>
                    <label for="pr_support">التحكم في الاعضاء</label>
                </div>
                <div class="ckbox ckbox-success col-sm-6">
                    <input name="pr_sms" type="checkbox" value="1" id="pr_sms" <?= $result['pr_sms'] == '1' ? "checked='checked'" : "" ?>>
