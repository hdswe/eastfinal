...
<div class="panel panel-default">
        ...
        <div class="panel-body panel-body-nopadding">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input name="url" type="text" class="form-control" id="url" value="<?=  $result['link'] ?>" />
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <img src="../data/images/<?=  $result['images'] ?>" width="200"  alt=""/>
                <input name="images_old" type="hidden" id="images_old" value="<?=  $result['images'] ?>">
              </div>
            </div>
