          ...
          <table class="table table-hidaction table-striped mb30" id="reservationTabel">
            ...
            <tbody>
                ...
                <td class="table-action">
                    <a href="?confirmed=<? echo $result['resid'] ?>" title="تأكيد الحجز" data-placement="top" data-toggle="tooltip" class="tooltips"><i class="fa fa-check-square-o"></i></a>

                    <a href="?del=<? echo $result['resid'] ?>" title="حذف الحجز" data-placement="top" data-toggle="tooltip" class="tooltips"><i class="fa fa-trash-o"></i></a>
