<div class="panel panel-default">
                ...
                <button name="ClosedChecked" type="submit" id="ClosedChecked" class="btn btn-primary"><span class="fa fa-lock"></span>&nbsp; اغلاق المحدد</button>
...
?>
                        ...
                        <a href="?do=reply_support&amp;id=<? echo $result['tickid'] ?>"><h4 class="text-primary"><?= $result['title']." - بواسطة : ".$result['full_name'] ?></h4></a>
