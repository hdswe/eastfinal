<div class="panel panel-default">
        ...
        <form action="" method="post" id="showform" name="showform" >
          ...
          <div class="mb30">
          <div class="col-sm-7">
            <a class="btn btn-primary" href="?do=add"><span class="fa fa-pencil-square-o"></span>&nbsp; اضافة صفحة</a>
        ...
        <? } ?>
          ...
          <table class="table table-hidaction table-striped mb30">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM `pages` ".$where." ORDER BY `id` DESC LIMIT $startpoint , $limit";
                ...
                <td><?= $result['title'] ?></td>
                <td><a href="../page.php?id=<?= $result['id'] ?>">page.php?id=<?= $result['id'] ?></a></td>
