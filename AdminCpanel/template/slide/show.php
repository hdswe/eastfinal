...
<div class="panel panel-default">
        <div class="panel-heading">
          ...
          <h3 class="panel-title">السلايدات</h3>
        </div>
        <div class="panel-body">
          <div class="table-responsive">
          <div class="mb30">
          <div class="col-sm-7">
            <a class="btn btn-primary" href="?do=add"><span class="fa fa-pencil-square-o"></span>&nbsp; اضافة سلايد</a>
        ...
        <div class="col-sm-5">
            <div class="form-group">
                <div class="col-sm-10">
                <input name="title" type="text" class="form-control input-sm" id="title" placeholder="عنوان السلايد">
                </div>
            <div class="col-sm-2">
        ...
        <? } ?>
          ...
          <table class="table table-hidaction table-striped mb30">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM `slide` ".$where." ORDER BY `id` DESC";
                ...
                <td><?= $result['title'] ?></td>
                <td><?= $result['status'] == '1' ? "ظاهر" : "مخفي" ?></td>
