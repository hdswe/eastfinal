		...
		<th>الحي</th>
            ...
            <tbody>
                ...
                $sql =  "SELECT 
                       ...
                       reservation.course_id = ".$record_day['course_id']." AND
                        reservation.user_id = users.id AND 
          
		users.id NOT in (SELECT registr_attend.user_id FROM registr_attend WHERE registr_attend.course_id=".$record_day['course_id']." AND registr_attend.day_course_id=".$record_day['id'].") ORDER BY users.full_name ASC";
                ...
                <td align="center"><? echo '<span class="glyphicon glyphicon-remove"></span>'; ?></td>
                </tr>
                <? } } ?>
